    ...
    try {
      const res = await fetch('https://api.anthropic.com/v1/messages', {
        ...
        body: JSON.stringify({
          ...
          messages: [{
            role: 'user',
            content: `Proporciona datos fundamentales actualizados sobre ${asset.ticker} (${asset.name}).
    ...
    try {
      const res = await fetch('https://api.anthropic.com/v1/messages', {
        ...
        body: JSON.stringify({
          ...
          messages: [{
            role: 'user',
            content: `Lista las 5 noticias más recientes e importantes sobre ${ticker} de los últimos 30 días.
              ...
              {aiLoading ? (
                ...
                <Card className="glass-card">
                  <CardContent className="py-10 text-center text-muted-foreground text-sm">
                    ...
                    <br /><span className="text-xs opacity-60">Requiere VITE_ANTHROPIC_API_KEY en GitHub Secrets.</span>
                  </CardContent>
                </Card>
              )}
            </TabsContent>
